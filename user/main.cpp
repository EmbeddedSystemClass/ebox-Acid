...
//************************线性回归计算和显示函数*********************// 
//FLUKE 5502A校准电流，最小55uA，再小不准，且输出线上损耗没有补偿∈实际应用中存在长线传输而导致电流损耗。 Y = -20.77718 + 0.32010*X1  
//double data1[12][2] = {
////    X      Y
//    {163 , 5},//5uA
//    {166, 10},//10
...
////    {4042, 1500},//1500
//};
//FLUKE 5502A校准电流，最小55uA，再小不准，且输出线上损耗没有补偿∈实际应用中存在长线传输而导致电流损耗。电路设计非线性造成
double data1[11][2] = {
//    X      Y
    {163 , 60},//60uA
    {270, 100},//100
...
//   uart1.printf( "Output:\n%s\ncharacter count = %d\n", buffer, j );
//**********字符串输出转换方式**测试代码********************//    
//            uart1.printf("%04d\t%0.4f\n",val_ch4,ambient_temperature_ch4);     
            uint8_t len = make_frame(I_voltage_ch1,S_voltage_ch2,K_voltage_ch3,LM35_voltage_ch4);
